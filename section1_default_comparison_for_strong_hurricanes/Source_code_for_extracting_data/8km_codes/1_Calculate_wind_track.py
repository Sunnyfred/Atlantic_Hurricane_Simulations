...
gridsize = '/8km/'
gridsize2 = '8km'
Dirall = ['WRFONLY_NoTurb_8km_isftcflx_1_changeClz_1p0000_MYJ',
       'WRFONLY_NoTurb_8km_isftcflx_0_changeClz_1p0000',
       'WRFSWAN_NoTurb_swdt10_cpdt7200_swgr8p0_swh8_swt14_A1200B4p5C0P11',
       'WRFONLY_NoTurb_8km_isftcflx_1_changeClz_1p0000',
       'WRFONLY_NoTurb_8km_isftcflx_2_changeClz_1p0000']
outputpath = '/project/momen/meng/COAWST/results/WRF_VS_WRFSWAN_2/postprocessing_WRFONLY/0_Paper_figures/section1_default_comparison_for_strong_winds/source_codes_outputs/8km/'
...
for Hurricane in Hurricaneall:
    ...
    with open(outputpath+Hurricane+'_track_'+gridsize2+'.txt', 'w') as outfile:  
        json.dump(real_dic, outfile) 
        for i in range(len(results)):    
            json.dump(results[i], outfile)     
            
    pickle.dump( slp2D, open( outputpath+Hurricane+'_'+gridsize2+'.p', "wb" ) )
