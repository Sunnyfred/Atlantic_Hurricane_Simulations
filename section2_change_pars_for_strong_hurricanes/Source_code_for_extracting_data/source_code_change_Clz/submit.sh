...
cd /project/momen/meng/COAWST/results/WRF_VS_WRFSWAN_2/postprocessing_WRFONLY/0_Paper_figures/section2_change_pars_for_strong_winds/source_code_change_Clz
...
###python3 1_Calculate_avg_speed_vs_slp.py
