...
dir_znt_eye_A = ['C:/Users/limgr/Desktop/A/Katrina_ZNT_eye_8km.csv',\
       'C:/Users/limgr/Desktop/A/Maria_ZNT_eye_8km.csv',\
       'C:/Users/limgr/Desktop/A/Irma_ZNT_eye_8km.csv',\
       'C:/Users/limgr/Desktop/A/Dorian_ZNT_eye_8km.csv',\
       'C:/Users/limgr/Desktop/A/Lorenzo_ZNT_eye_8km.csv'] 




dir_znt_eye_B = ['C:/Users/limgr/Desktop/B/Katrina_ZNT_eye_8km.csv',\
       'C:/Users/limgr/Desktop/B/Maria_ZNT_eye_8km.csv',\
       'C:/Users/limgr/Desktop/B/Irma_ZNT_eye_8km.csv',\
       'C:/Users/limgr/Desktop/B/Dorian_ZNT_eye_8km.csv',\
       'C:/Users/limgr/Desktop/B/Lorenzo_ZNT_eye_8km.csv'] 
...
for kk in range(len(hurricanes)):
    ...
    Times=[]
    values=[]
    with open(dir_znt_eye_A[kk], mode='r') as csv_file:
...
for kk in range(len(hurricanes)):
    ...
    Times=[]
    values=[]
    with open(dir_znt_eye_B[kk], mode='r') as csv_file:
        csv_reader = csv.DictReader(csv_file)
        line_count = 0
        for row in csv_reader:
            if line_count == 0:
    ...
    for i in range(0,line_count-1):
        ...
        if hurricanes[kk]=='Katrina':
            plt.plot( Times0[:5], tmp[:5], color = colors2[c+1], \
                      linestyle=list(linestyles2.values())[c+1],\
                  linewidth=5, markersize=sizes[c+1])
            plt.xticks(fontsize=25, **csfont)
            plt.yticks(fontsize=25, **csfont)
            plt.ylim([1e-6, 3.0])
            ...
            plt.plot( Times0[:-2], tmp[:-2], color = colors2[c+1], \
                      linestyle=list(linestyles2.values())[c+1],\
                  linewidth=5, markersize=sizes[c+1])
            plt.xticks(fontsize=25, **csfont)
            plt.yticks(fontsize=25, **csfont)
            ...
            plt.plot( Times0, tmp, color = colors2[c+1], \
                      linestyle=list(linestyles2.values())[c+1],\
                  linewidth=5, markersize=sizes[c+1])
            plt.xticks(fontsize=25, **csfont)
            plt.yticks(fontsize=25, **csfont)
...
plt.savefig('C:/Users/limgr/Desktop/ZNT_eye_AB.png', dpi=500)
plt.show()
