...
dir_wi1 = ['C:/Users/limgr/Desktop/1/Cristobal_wind_intensity_2km.csv',\
       'C:/Users/limgr/Desktop/1/Gert_wind_intensity_2km.csv',\
       'C:/Users/limgr/Desktop/1/Ike_wind_intensity_2km.csv',\
       'C:/Users/limgr/Desktop/1/Joaquin_wind_intensity_2km.csv',\
       'C:/Users/limgr/Desktop/1/Nicole_wind_intensity_2km.csv']

    
dir_wt1 = ['C:/Users/limgr/Desktop/1/Cristobal_track_2km.txt',\
       'C:/Users/limgr/Desktop/1/Gert_track_2km.txt',\
       'C:/Users/limgr/Desktop/1/Ike_track_2km.txt',\
       'C:/Users/limgr/Desktop/1/Joaquin_track_2km.txt',\
       'C:/Users/limgr/Desktop/1/Nicole_track_2km.txt']    
...
dir_wi3 = ['C:/Users/limgr/Desktop/3/Cristobal_wind_intensity_16km.csv',\
       'C:/Users/limgr/Desktop/3/Gert_wind_intensity_16km.csv',\
       'C:/Users/limgr/Desktop/3/Ike_wind_intensity_16km.csv',\
       'C:/Users/limgr/Desktop/3/Joaquin_wind_intensity_16km.csv',\
       'C:/Users/limgr/Desktop/3/Nicole_wind_intensity_16km.csv']

    
dir_wt3 = ['C:/Users/limgr/Desktop/3/Cristobal_track_16km.txt',\
       'C:/Users/limgr/Desktop/3/Gert_track_16km.txt',\
       'C:/Users/limgr/Desktop/3/Ike_track_16km.txt',\
       'C:/Users/limgr/Desktop/3/Joaquin_track_16km.txt',\
       'C:/Users/limgr/Desktop/3/Nicole_track_16km.txt']        
                    ...
                    with open(dirx[kk], mode='r') as csv_file:
                        ...
                        for row in csv_reader:
                            if line_count == 0:
                                ...
                                values1.append(list(row.values()))
                                line_count += 1
                        print('There is2 totally ',(line_count-1),len(row),' data points') 
                        print('There is2 totally ',(line_count-1)*(len(row)),' data points')            
...
CTEs_wi1_ = [par1_error_wi_mean_all[0],\
        par2_error_wi_mean_all[0],par3_error_wi_mean_all[0]]
errors_wi1_ = [par1_error_wi_std_all[0],\
          par2_error_wi_std_all[0],par3_error_wi_std_all[0]]
percentile_10_wi1_ = np.array([par1_error_wi_mean_all[0]-par1_error_wi_low_all[0],\
          par2_error_wi_mean_all[0]-par2_error_wi_low_all[0],par3_error_wi_mean_all[0]-par3_error_wi_low_all[0]])
percentile_90_wi1_ = np.array([par1_error_wi_hgh_all[0]-par1_error_wi_mean_all[0],\
          par2_error_wi_hgh_all[0]-par2_error_wi_mean_all[0],par3_error_wi_hgh_all[0]-par3_error_wi_mean_all[0]])


CTEs_wt1_ = [par1_error_wt_mean_all[0],\
        par2_error_wt_mean_all[0],par3_error_wt_mean_all[0]]
errors_wt1_ = [par1_error_wt_std_all[0],\
          par2_error_wt_std_all[0],par3_error_wt_std_all[0]]
percentile_10_wt1_ = np.array([par1_error_wt_mean_all[0]-par1_error_wt_low_all[0],\
          par2_error_wt_mean_all[0]-par2_error_wt_low_all[0],par3_error_wt_mean_all[0]-par3_error_wt_low_all[0]])
percentile_90_wt1_ = np.array([par1_error_wt_hgh_all[0]-par1_error_wt_mean_all[0],\
          par2_error_wt_hgh_all[0]-par2_error_wt_mean_all[0],par3_error_wt_hgh_all[0]-par3_error_wt_mean_all[0]])




CTEs_wi2_ = [par1_error_wi_mean_all[1],\
        par2_error_wi_mean_all[1],par3_error_wi_mean_all[1]]
errors_wi2_ = [par1_error_wi_std_all[1],\
          par2_error_wi_std_all[1],par3_error_wi_std_all[1]]
percentile_10_wi2_ = np.array([par1_error_wi_mean_all[1]-par1_error_wi_low_all[1],\
          par2_error_wi_mean_all[1]-par2_error_wi_low_all[1],par3_error_wi_mean_all[1]-par3_error_wi_low_all[1]])
percentile_90_wi2_ = np.array([par1_error_wi_hgh_all[1]-par1_error_wi_mean_all[1],\
          par2_error_wi_hgh_all[1]-par2_error_wi_mean_all[1],par3_error_wi_hgh_all[1]-par3_error_wi_mean_all[1]])


CTEs_wt2_ = [par1_error_wt_mean_all[1],\
        par2_error_wt_mean_all[1],par3_error_wt_mean_all[1]]
errors_wt2_ = [par1_error_wt_std_all[1],\
          par2_error_wt_std_all[1],par3_error_wt_std_all[1]]
percentile_10_wt2_ = np.array([par1_error_wt_mean_all[1]-par1_error_wt_low_all[1],\
          par2_error_wt_mean_all[1]-par2_error_wt_low_all[1],par3_error_wt_mean_all[1]-par3_error_wt_low_all[1]])
percentile_90_wt2_ = np.array([par1_error_wt_hgh_all[1]-par1_error_wt_mean_all[1],\
...
CTEs_wi3_ = [par1_error_wi_mean_all[2],\
        par2_error_wi_mean_all[2],par3_error_wi_mean_all[2]]
errors_wi3_ = [par1_error_wi_std_all[2],\
          par2_error_wi_std_all[2],par3_error_wi_std_all[2]]
percentile_10_wi3_ = np.array([par1_error_wi_mean_all[2]-par1_error_wi_low_all[2],\
          par2_error_wi_mean_all[2]-par2_error_wi_low_all[2],par3_error_wi_mean_all[2]-par3_error_wi_low_all[2]])
percentile_90_wi3_ = np.array([par1_error_wi_hgh_all[2]-par1_error_wi_mean_all[2],\
          par2_error_wi_hgh_all[2]-par2_error_wi_mean_all[2],par3_error_wi_hgh_all[2]-par3_error_wi_mean_all[2]])


CTEs_wt3_ = [par1_error_wt_mean_all[2],\
        par2_error_wt_mean_all[2],par3_error_wt_mean_all[2]]
errors_wt3_ = [par1_error_wt_std_all[2],\
          par2_error_wt_std_all[2],par3_error_wt_std_all[2]]
percentile_10_wt3_ = np.array([par1_error_wt_mean_all[2]-par1_error_wt_low_all[2],\
          par2_error_wt_mean_all[2]-par2_error_wt_low_all[2],par3_error_wt_mean_all[2]-par3_error_wt_low_all[2]])
percentile_90_wt3_ = np.array([par1_error_wt_hgh_all[2]-par1_error_wt_mean_all[2],\
...
CTEs_wi1 = [CTEs_wi1_[0], CTEs_wi2_[0], CTEs_wi3_[0] ]
errors_wi1 = [errors_wi1_[0], errors_wi2_[0], errors_wi3_[0] ]
percentile_10_wi1 = [percentile_10_wi1_[0], percentile_10_wi2_[0], percentile_10_wi3_[0]]
percentile_90_wi1 = [percentile_90_wi1_[0], percentile_90_wi2_[0], percentile_90_wi3_[0]]


CTEs_wi2 = [CTEs_wi1_[1], CTEs_wi2_[1], CTEs_wi3_[1] ]
errors_wi2 = [errors_wi1_[1], errors_wi2_[1], errors_wi3_[1] ]
percentile_10_wi2 = [percentile_10_wi1_[1], percentile_10_wi2_[1], percentile_10_wi3_[1]]
percentile_90_wi2 = [percentile_90_wi1_[1], percentile_90_wi2_[1], percentile_90_wi3_[1]]


CTEs_wi3 = [CTEs_wi1_[2], CTEs_wi2_[2], CTEs_wi3_[2] ]
errors_wi3 = [errors_wi1_[2], errors_wi2_[2], errors_wi3_[2] ]
percentile_10_wi3 = [percentile_10_wi1_[2], percentile_10_wi2_[2], percentile_10_wi3_[2]]
percentile_90_wi3 = [percentile_90_wi1_[2], percentile_90_wi2_[2], percentile_90_wi3_[2]]





CTEs_wt1 = [CTEs_wt1_[0], CTEs_wt2_[0], CTEs_wt3_[0] ]
errors_wt1 = [errors_wt1_[0], errors_wt2_[0], errors_wt3_[0] ]
percentile_10_wt1 = [percentile_10_wt1_[0], percentile_10_wt2_[0], percentile_10_wt3_[0]]
percentile_90_wt1 = [percentile_90_wt1_[0], percentile_90_wt2_[0], percentile_90_wt3_[0]]


CTEs_wt2 = [CTEs_wt1_[1], CTEs_wt2_[1], CTEs_wt3_[1] ]
errors_wt2 = [errors_wt1_[1], errors_wt2_[1], errors_wt3_[1] ]
percentile_10_wt2 = [percentile_10_wt1_[1], percentile_10_wt2_[1], percentile_10_wt3_[1]]
percentile_90_wt2 = [percentile_90_wt1_[1], percentile_90_wt2_[1], percentile_90_wt3_[1]]


CTEs_wt3 = [CTEs_wt1_[2], CTEs_wt2_[2], CTEs_wt3_[2] ]
errors_wt3 = [errors_wt1_[2], errors_wt2_[2], errors_wt3_[2] ]
percentile_10_wt3 = [percentile_10_wt1_[2], percentile_10_wt2_[2], percentile_10_wt3_[2]]
percentile_90_wt3 = [percentile_90_wt1_[2], percentile_90_wt2_[2], percentile_90_wt3_[2]]
...
bars = ax.bar(x_pos-0.25, CTEs_wi1, yerr=err_wi1, align='center', \
        color=['cyan','gray', 'red'], alpha=0.8, width=0.25,\
...
bars = ax.bar(x_pos+0.25, CTEs_wi3, yerr=err_wi3, align='center', \
        color=['cyan','gray', 'red'], alpha=0.8, width=0.25,\
...
ax.set_xticks(x_pos)
ax.set_xticklabels(gridsizes, **csfont, fontsize=12)
...
bars = ax.bar(x_pos-0.25, CTEs_wt1, yerr=err_wt1, align='center', \
        color=['cyan','gray', 'red'], alpha=0.8, width=0.25,\
        ecolor='k', capsize=5, edgecolor='k', linewidth=1, hatch='///') 
for i in range(len(x_pos)):
    bars[i].set(linestyle=list(linestyles.values())[0])
...
bars = ax.bar(x_pos+0.25, CTEs_wt3, yerr=err_wt3, align='center', \
        color=['cyan','gray', 'red'], alpha=0.8, width=0.25,\
        ecolor='k', capsize=5, edgecolor='k', linewidth=1) 
for i in range(len(x_pos)):
    bars[i].set(linestyle=list(linestyles.values())[0])    
...
plt.legend(handles, ['Clz=0.01', 'Clz=1', 'Clz=100'], ncol=3, \
           bbox_to_anchor=(0.8, 0.8), prop=fontbar, frameon=False)
...
plt.savefig('C:/Users/limgr/Desktop/wi_wt_bar_plots_3gridsizes.png', dpi=500)
plt.show()
