...
dir_wi = ['C:/Users/limgr/Desktop/Cristobal_wind_intensity_2km.csv',\
       'C:/Users/limgr/Desktop/Gert_wind_intensity_2km.csv',\
       'C:/Users/limgr/Desktop/Ike_wind_intensity_2km.csv',\
       'C:/Users/limgr/Desktop/Joaquin_wind_intensity_2km.csv',\
       'C:/Users/limgr/Desktop/Nicole_wind_intensity_2km.csv']

    
dir_wt = ['C:/Users/limgr/Desktop/Cristobal_track_2km.txt',\
       'C:/Users/limgr/Desktop/Gert_track_2km.txt',\
       'C:/Users/limgr/Desktop/Ike_track_2km.txt',\
       'C:/Users/limgr/Desktop/Joaquin_track_2km.txt',\
       'C:/Users/limgr/Desktop/Nicole_track_2km.txt']    

dir_p = ['C:/Users/limgr/Desktop/Cristobal_2km.p',\
       'C:/Users/limgr/Desktop/Gert_2km.p',\
       'C:/Users/limgr/Desktop/Ike_2km.p',\
       'C:/Users/limgr/Desktop/Joaquin_2km.p',\
       'C:/Users/limgr/Desktop/Nicole_2km.p']    

dir_znt_eye = ['C:/Users/limgr/Desktop/Cristobal_ZNT_eye_2km.csv',\
       'C:/Users/limgr/Desktop/Gert_ZNT_eye_2km.csv',\
       'C:/Users/limgr/Desktop/Ike_ZNT_eye_2km.csv',\
       'C:/Users/limgr/Desktop/Joaquin_ZNT_eye_2km.csv',\
       'C:/Users/limgr/Desktop/Nicole_ZNT_eye_2km.csv'] 

dir_znt_eyewall = ['C:/Users/limgr/Desktop/Cristobal_ZNT_eyewall_2km.csv',\
       'C:/Users/limgr/Desktop/Gert_ZNT_eyewall_2km.csv',\
       'C:/Users/limgr/Desktop/Ike_ZNT_eyewall_2km.csv',\
       'C:/Users/limgr/Desktop/Joaquin_ZNT_eyewall_2km.csv',\
       'C:/Users/limgr/Desktop/Nicole_ZNT_eyewall_2km.csv'] 



# dir_wp = ['C:/Users/limgr/Desktop/Katrina_avg_speed_2km.csv', \
#           'C:/Users/limgr/Desktop/Maria_avg_speed_2km.csv', \
#           'C:/Users/limgr/Desktop/Irma_avg_speed_2km.csv', \
#           'C:/Users/limgr/Desktop/Dorian_avg_speed_2km.csv', \
#           'C:/Users/limgr/Desktop/Lorenzo_avg_speed_2km.csv'] 
...
for kk in range(len(hurricanes)):
    ...
    fig.legend(options, bbox_to_anchor=(0.87, 0.35), prop=font, \
                frameon=False)
...
for kk in range(len(hurricanes)):
    ...
    for axis in ['top','bottom','left','right']:
        ax.spines[axis].set_linewidth(2)
    ax.tick_params(length=5, width=2)
    fig.legend(models, bbox_to_anchor=(0.87, 0.35), prop=font, \
                frameon=False)
...
par1_error_wi=np.zeros((3, 9))
par2_error_wi=np.zeros((3, 9))
par3_erro_wir=np.zeros((3, 9))
...
par1_error=np.zeros((3, 9))
par2_error=np.zeros((3, 9))
par3_error=np.zeros((3, 9))
par4_error=np.zeros((3, 9))
...
CTEs_wi = [par1_error_wi_mean,\
        par2_error_wi_mean,par3_error_wi_mean]
errors_wi = [par1_error_wi_std,\
          par2_error_wi_std,par3_error_wi_std]
...
CTEs_wt = [par1_error_wt_mean,\
        par2_error_wt_mean,par3_error_wt_mean]
errors_wt = [par1_error_wt_std,\
          par2_error_wt_std,par3_error_wt_std]
...
plt.legend(handles, models, ncol=4, bbox_to_anchor=(0.8, 0.8), prop=fontbar, \
                frameon=False)
