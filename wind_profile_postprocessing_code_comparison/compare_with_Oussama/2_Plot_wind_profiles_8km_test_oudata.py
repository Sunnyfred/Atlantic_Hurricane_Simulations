...
colors = ['blue','gray', 'red','blue','gray', 'red', \
...
dir_wp = ['C:/Users/limgr/Desktop/Katrina_wind_profiles_8km.csv',\
       'C:/Users/limgr/Desktop/Maria_wind_profiles_8km.csv',\
       'C:/Users/limgr/Desktop/Irma_wind_profiles_8km.csv',\
       'C:/Users/limgr/Desktop/Dorian_wind_profiles_8km.csv',\
       'C:/Users/limgr/Desktop/Lorenzo_wind_profiles_8km.csv']
dir_wp = ['C:/Users/limgr/Desktop/Maria_wind_profiles_8km_oudata_16.csv']
...
for kk in range(len(hurricanes)):
    ...
    ax = fig.add_subplot(spec[0:9,0:23])
    ...
    for i in range(0,line_count-1):
        ...
        if c<3:
            plt.plot( tmp, Times0, color = colors[c], \
                      linestyle=list(linestyles.values())[1],\
    ...
    fig.legend(options, bbox_to_anchor=(0.9, 0.9), prop=font, \
                frameon=False)
...
# ax = fig.add_subplot(spec[0:9,0:23])
ax.text(0.05, 0.9, r'$0.995 \leq \frac{slp}{slp_{max-wi}} \leq 1.000$', \
